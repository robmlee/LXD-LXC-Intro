...
----
### 2. 以 iso 檔建立 GUI VM (桌面版 VM)

**以 iso 檔來建立 GUI VM (桌面版 VM)，建議使用[Using LXD UI](https://github.com/robmlee/LXD-LXC-Intro/blob/2e3803f96b70f760930be2ebf2cde63d155c7e03/11.%20Using_LXD_UI.md) 這一篇中的方式來操作，會比較簡單。**

- **2-1. 建立指令，以 Ubuntu iso 為例：**
